              ...
              <div className="text-center lg:text-left space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-base text-gray-600 leading-relaxed max-w-5xl">
                    Passionate AI/ML engineer with expertise in machine learning, data science, and web development. Currently interning in AI/ML while pursuing my final year in Statistics and Operations Research. I love turning complex data into meaningful insights and building innovative solutions.
                  </p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Statistics graduate and AI/ML enthusiast passionate about data science, machine learning, and turning complex data into meaningful insights.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    <a href="https://github.com/sahastraG39" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-300 transition-colors p-2 bg-gray-800 rounded-lg hover:bg-gray-700">
                    ...
                    <a href="https://www.linkedin.com/in/sahastra-gunasegaram?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BJqT4EU28R%2BOMx8Rtg1iaiw%3D%3D" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-300 transition-colors p-2 bg-gray-800 rounded-lg hover:bg-gray-700">
                      <span className="sr-only">LinkedIn</span>
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                      </svg>
                    </a>
                    <a href="mailto:arthyhgunam63@gmail.com" className="text-gray-400 hover:text-purple-300 transition-colors p-2 bg-gray-800 rounded-lg hover:bg-gray-700">
              ...
              <div className="space-y-4">
                <div>
                  <div className="bg-gray-800 p-5 rounded-lg border border-purple-700">
                    ...
                    <div id="quote-explanation" className="hidden mt-3 p-3 bg-gray-700 rounded-lg border border-purple-600">
