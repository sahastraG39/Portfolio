...
const projects = [
  ...
  },
  {
    ...
    technologies: ['Django', 'Python', 'Hugging Face Transformers', 'FAISS', 'LangChain', 'Docker', 'Legal-BERT', 'BART'],
    ...
    <section id="projects" className="scroll-mt-24 bg-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4 animate-fade-in-up">Featured Projects</h2>
