export function EducationSection() {
  return (
    <section id="education" className="scroll-mt-24 bg-gradient-to-br from-gray-50 to-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto animate-fade-in-up" style={{animationDelay: '0.2s'}}>
           ...
           {/* Education Cards */}
           <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover-lift transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
             ...
             <div className="space-y-4">
               <div className="p-4 bg-gray-50 rounded-lg">
                 ...
                 <p className="text-blue-600 font-medium">B.Sc. (Hons.) in Statistics and Operations Research</p>
               ...
               <div className="p-4 bg-gray-50 rounded-lg">
                 ...
                 <p className="text-blue-600 font-medium">Certificate Programming in IT Applications</p>
           ...
           <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover-lift transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
             <div className="flex items-center mb-4">
             ...
             <div className="space-y-4">
               <div className="p-4 bg-gray-50 rounded-lg">
                 ...
                 <p className="text-gray-600 text-sm">Developing innovative solutions in machine learning with AI</p>
               </div>
